<!-- mcp-name: CSOAI-ORG/clinical-trials-ai-mcp -->
[![MCP Scorecard: 74/100](https://img.shields.io/badge/proofof.ai-74%2F100-5b21b6)](https://proofof.ai/scorecard/clinical-trials-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/clinical_trials_ai_mcp/)

> Search clinical trials, evaluate eligibility, compare trials, and retrieve endpoint data
...
```bash
# Install via pip
pip install clinical_trials_ai_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install clinical-trials-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/clinical-trials-ai-mcp)
